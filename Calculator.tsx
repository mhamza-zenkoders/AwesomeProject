...
export const Calculator: React.FC = () => {
  ...
  const functionButtons: string[] = ['AC', '+/-', '%']
  const operatorButtons: string[] = ['÷', '×', '-', '+', '=']

  const handlePress = (keyValue: string): void => {
    if (keyValue === 'ICON') {
      return;
    }
    else if (keyValue == 'AC') {
  ...
  const buttonColor = (button: string): object | undefined => {
  ...
  const buttonTextSize = (button: string): object | undefined => {
